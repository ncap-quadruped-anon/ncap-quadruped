...
from ncap_deploy.envs import locomotion_gym_config
from ncap_deploy.robots import (a1_robot_velocity_estimator, laikago_constants,
...
# First epoch's gains
ABDUCTION_P_GAIN = 90.0
ABDUCTION_D_GAIN = 3.0
HIP_P_GAIN = 90.0
HIP_D_GAIN =3.0
KNEE_P_GAIN = 90.0
KNEE_D_GAIN = 3.0
...
URDF_FILENAME = os.path.join(parentdir, "ncap_deploy/utilities/a1/a1.urdf")
